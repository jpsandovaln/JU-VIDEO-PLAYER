...
// subsequent calls to remove/insertString should be ignored
	...
	public AutoCompletion(final JComboBox<?> comboBox) {
		...
		editorFocusListener = new FocusAdapter() {
			public void focusGained(FocusEvent e) {
				...
				editor.setForeground(ResponsiveSwingMaterialDesign.SECONDARY_COLOR);

				comboBox.setBorder(new RoundedBorder(20, ResponsiveSwingMaterialDesign.PRIMARY_COLOR));
			}
			...
			public void focusLost(FocusEvent e) {
				...
				comboBox.setForeground(ResponsiveSwingMaterialDesign.SECONDARY_COLOR);
	...
	void configureEditor(ComboBoxEditor newEditor) {
		...
		if (newEditor != null) {
			...
			editor.setBorder(new EmptyBorder(0, 30, 0, 3));
			editor.setForeground(ResponsiveSwingMaterialDesign.SECONDARY_COLOR);
			comboBox.setBorder(new RoundedBorder(20, ResponsiveSwingMaterialDesign.SECONDARY_COLOR));
		}
	}
	...
	private void highlightCompletedText(int start) {
		try {
			...
			try {
				editor.setCaretPosition(getLength()-1);
				editor.moveCaretPosition(start);
			} catch (Exception e2) {
