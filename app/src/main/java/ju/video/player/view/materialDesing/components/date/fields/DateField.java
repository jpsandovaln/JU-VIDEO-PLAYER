...
import ju.video.player.view.materialDesing.animation.AnimateComponent;
...
public class DateField {
	...
	private Font labelFont = Utils.getMainFont(14);
	...
	private void build() {
		...
		RoundedBorder border = new RoundedBorder(10, ResponsiveSwingMaterialDesign.PRIMARY_COLOR);
		...
		textField.setFont(Utils.getMainFont(20));
		...
		calendarIcon.setBounds((textField.getWidth() - 64) + textField.getX(), textField.getY() + (textField.getHeight() / 2) - 16, 25, 25);
